...
class Contact(models.Model):
    """
    Class to safe contact form data.
    """

    contact_full_name = models.CharField(max_length=100, null=False, blank=False)
    contact_email = models.EmailField(max_length=254, null=False, blank=False)
    contact_ordernumber = models.CharField(max_length=100, null=True, blank=True)
    contact_issue = models.CharField(max_length=100, choices=CONTACT_CHOICES, default='choices')
